    ...
    return (
        <>
            <div className="grid grid-cols-2 md:grid-cols-8 bg-slate-100 md:min-h-screen">
                ...
                <div className="order-2 sm:order-2 col-span-2 sm:col-span-4">
                    <HomePage />
                </div>

                {/* Right Panel - Player 1 */}
                <div className="order-1 sm:order-1 col-span-2 sm:col-span-2">
                    <RightPanal/>
                </div>

                <div className="order-3 sm:order-3 col-span-2 sm:col-span-2">
                    <LeftPanal />
                </div> 
            </div>
